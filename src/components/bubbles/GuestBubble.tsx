...
export const GuestBubble = (props: Props) => {
  ...
  return (
    <div class="flex justify-end mb-2 items-end guest-container" style={{ 'margin-left': '50px' }}>
      ...
      <div
        class="text-link-color font-dubai max-w-full flex flex-col justify-center items-start chatbot-guest-bubble px-5 py-3 gap-2 mr-2 mb-5"
      ...
      >
        {props.message.fileUploads && props.message.fileUploads.length > 0 && (
          <div class="flex flex-col items-start flex-wrap w-full gap-2 mb-5">
        ...
        {props.message.message && (
          <span
            ...
            style={{ 'font-size': "14px", 'line-height': "22px", color: "#fff" }}
          />
        )}
      </div>
