        ...
        {props.showTitle ? (
          ...
          >
            ...
            <Show when={props.title}>
              <span class="px-3 whitespace-pre-wrap font-semibold max-w-full font-dubai">{props.title}</span>
            </Show>
            <div style={{ flex: 1 }} />
            <DeleteButton
        ...
        <div class="flex flex-col w-full h-full justify-start z-0">
                  ...
                  <>
                    ...
                    {message.type === 'apiMessage' && (
                      <BotBubble
                        ...
                        showAvatar={true}
                        avatarSrc="https://metadesignsolutions.com/wp-content/uploads/2025/05/lamya-chatbot.gif"
          ...
          <Show when={messages().length === 1}>
            <Show when={starterPrompts().length > 0}>
              <div class="w-full flex flex-row flex-wrap px-5 py-[10px] gap-2 items-center justify-center">
